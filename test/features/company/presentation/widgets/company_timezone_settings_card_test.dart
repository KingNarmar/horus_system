...
void main() {
  testWidgets('owner sees timezone editor and current value', (tester) async {
    ...
    expect(find.text('Current timezone: Asia/Dubai'), findsOneWidget);
    expect(find.byType(DropdownButtonFormField<String>), findsOneWidget);
    expect(find.text('Save timezone'), findsOneWidget);
  });

  testWidgets('viewer sees current timezone without management controls', (
    tester,
  ) async {
    final cubit = _buildCubit();
    addTearDown(cubit.close);
