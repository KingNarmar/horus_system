...
void main() {
  group('CustomersRepositoryImpl', () {
    ...
    test('adds a customer through the business data source', () async {
    ...
    test('deactivates without a second client-side persistence call', () async {
      final operations = <String>[];
      final remoteDataSource = _FakeCustomersRemoteDataSource(
        operations: operations,
      );
    ...
    test('reactivates without a second client-side persistence call', () async {
      final operations = <String>[];
      final remoteDataSource = _FakeCustomersRemoteDataSource(
        operations: operations,
      );
    ...
    test('sanitizes mutation failures', () async {
      final operations = <String>[];
      final repository = _repository(
