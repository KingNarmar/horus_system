...
import 'package:horus_system/features/routes/presentation/widgets/route_activity_dialog.dart';
    ...
    for (final width in [390.0, 1280.0]) {
      testWidgets('renders projected activity in $language at width $width', (
        ...
        final state = RoutesLoaded(
          ...
          allRoutes: const [entity],
          canManageRoutes: true,
          selectedRoute: entity,
          selectedRouteActivity: [log],
          ...
          MaterialApp(
            ...
            home: Builder(
              builder: (context) {
                ...
                return Scaffold(
                  body: RouteDetailsDialog(route: entity, state: state),
                );
              },
            ),
          ),
