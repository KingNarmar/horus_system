-- H.O.R.U.S System — Issue #29 Dashboard COALESCE fix
--
-- COALESCE is SQL syntax, not a schema-qualified pg_catalog function. Replace
-- the invalid qualification while preserving the invoker/RLS security model.
