...
class DeactivateCustomerParams {
  final CurrentCompanyContext currentCompanyContext;
  final String customerId;

  const DeactivateCustomerParams({
...
class DeactivateCustomerUseCase
    implements UseCase<Customer, DeactivateCustomerParams> {
  final CustomersRepository _repository;

  const DeactivateCustomerUseCase(this._repository);

  @override
  Future<Result<Customer>> call(DeactivateCustomerParams params) {
