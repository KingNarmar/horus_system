...
extension CompanyExpenseCategoryLocalizationsX on AppLocalizations {
  ...
  String companyExpenseCategoryName({
    ...
    return switch (code) {
      'vehicle_maintenance' =>
        _isArabicCompanyExpenseCategory
            ? 'صيانة المركبات'
            : 'Vehicle maintenance',
      'spare_parts' =>
        _isArabicCompanyExpenseCategory ? 'قطع الغيار' : 'Spare parts',
      'tires' => _isArabicCompanyExpenseCategory ? 'الإطارات' : 'Tires',
      'oils_and_fluids' =>
        _isArabicCompanyExpenseCategory ? 'الزيوت والسوائل' : 'Oils and fluids',
      'licenses_and_renewals' =>
        _isArabicCompanyExpenseCategory
            ? 'التراخيص والتجديدات'
            : 'Licenses and renewals',
      'office_expenses' =>
        _isArabicCompanyExpenseCategory ? 'مصروفات المكتب' : 'Office expenses',
      'rent' => _isArabicCompanyExpenseCategory ? 'الإيجار' : 'Rent',
      'salaries' => _isArabicCompanyExpenseCategory ? 'الرواتب' : 'Salaries',
      'admin_costs' =>
        _isArabicCompanyExpenseCategory ? 'المصروفات الإدارية' : 'Admin costs',
