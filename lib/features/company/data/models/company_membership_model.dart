...
class CompanyMembershipModel {
  ...
  factory CompanyMembershipModel.fromMap(Map<String, dynamic> map) {
    final companyMap = Map<String, dynamic>.from(map[CompanyDbFields.companiesTable] as Map);

    return CompanyMembershipModel(
      company: CompanyModel.fromMap(companyMap),
      role: CompanyRoleModelMapper.fromDatabaseValue(map[CompanyDbFields.role] as String?),
