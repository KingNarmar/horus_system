...
class ReactivateCompanyMemberParams {
  final CurrentCompanyContext currentCompanyContext;
  final String membershipId;
  final CompanyRole targetRole;

  const ReactivateCompanyMemberParams({
...
class ReactivateCompanyMemberUseCase
    implements UseCase<void, ReactivateCompanyMemberParams> {
  final CompanyMembershipRepository _repository;

  const ReactivateCompanyMemberUseCase(this._repository);

  @override
  Future<Result<void>> call(ReactivateCompanyMemberParams params) {
