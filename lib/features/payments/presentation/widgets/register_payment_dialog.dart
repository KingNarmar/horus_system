...
final class _RegisterPaymentForm extends StatefulWidget {
  final RegisterPaymentReady state;

  const _RegisterPaymentForm({required this.state});

  @override
  State<_RegisterPaymentForm> createState() => _RegisterPaymentFormState();
}

final class _RegisterPaymentFormState extends State<_RegisterPaymentForm> {
...
final class _BalanceSummary extends StatelessWidget {
  final PayableInvoice invoice;
