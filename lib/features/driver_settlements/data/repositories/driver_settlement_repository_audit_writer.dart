      ...
      CreateAuditLogParams(
        data: AuditLogWriteData(
          ...
          metadata: {
            ...
            'compensation_revision_id': model.compensationRevisionId,
            'currency_code': model.currencyCode,
            'currency_fraction_digits': model.currencyFractionDigits,
            'closing_driver_balance': model.closingDriverBalance,
            'closing_driver_balance_minor_units':
                model.closingDriverBalanceMinorUnits,
            'net_salary_payable': model.netSalaryPayable,
            'net_salary_payable_minor_units': model.netSalaryPayableMinorUnits,
            'gross_salary_minor_units': model.grossSalaryMinorUnits,
          },
        ),
      ),
    );
