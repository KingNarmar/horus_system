...
///
/// English and Arabic values live together here so the feature has one
/// localization source and cannot drift between duplicated ARB and Dart maps.
class DriverSettlementsLocalizations {
  ...
  static const Map<String, String> _ar = {
    ...
    'showVoided': 'إظهار التسويات المبطلة',
    ...
    'void': 'إبطال',
    'voiding': 'جاري الإبطال...',
    'voidTitle': 'إبطال التسوية',
    'voidMessage': 'هل تريد إبطال هذه التسوية؟ ستظل محفوظة في السجل المالي.',
    'voidReasonRequired': 'سبب الإبطال مطلوب.',
    ...
    'settlementVoided': 'تم إبطال التسوية.',
